...
const SubjectWiseMarkApply = () => {
  ...
  const subjectMarkHandler = (start, end, subName, correctMark, wrongMark) => {
    ...
    toast.success("subject added for marking")
  };
        ...
        >
          ...
          <div className="flex  max-[816px]:flex-col-reverse  items-center">
            <div className="min-[816px]:w-[60%] mt-4">
              ...
              <div className="flex justify-between mt-2 mx-4 min-[816px]:text-center ">
                <div className="font-semibold text-[1rem] mx-4">
                  <p>
            ...
            <div className=" mt-4 h-[250px] w-[60%] min-[816px]:w-[40%] mx-2 flex flex-col items-center bg-white shadow-md shadow-blue-400 ">
              <div className="bg-blue-400 w-[100%] text-center font-semibold text-xl py-2 text-yellow-400">
                Selected Subject
              </div>
              <div className="overflow-y-scroll h-[200px] w-[100%] text-center  ">
                ...
                {subjectWiseMarking.map((current) => (
                  <div className="font-bold bg-white items-center border-b border-blue-600 flex justify-between py-2">
                    <div className="w-[100%] gap-1 px-1">
                      <p className="ms-2 text-gray-400 text-[.8rem] text-left">
                        {current.subject}
                      </p>
                      <div className="flex justify-between ">
                        {" "}
                        <p className="text-[.75rem] font-semibold  text-left  flex gap-2">
                          <span>S : {keyHEaders[0][current.start]}</span>
                          {/* <span> ={">"} </span> */}
                          <span>E : {keyHEaders[0][current.end]}</span>
                        </p>
                        <p className="text-[.8rem] font-semibold text-left flex gap-2">
                          <span className="text-green-700">R : + {current.correctPoint}</span>

                          <span className="text-red-500"> W : - {current.wrongPoint}</span>
                        </p>
                      </div>
                    </div>
                    <p className="mx-2">
                      <RiDeleteBin6Line
                        ...
                        onClick={() => {
                          ...
                          toast.success("subject removed from marking list")
                        }}
                      />
                    </p>
                  </div>
